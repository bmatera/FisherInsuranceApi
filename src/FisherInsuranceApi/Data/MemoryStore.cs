...
namespace FisherInsuranceApi.Data
{
    public class MemoryStore : IMemoryStore
    {
        ...
        public MemoryStore()
        {
            quotes = new Dictionary<int, Quote>();  // This is the key/value pair data structure to hold quotes. It's like a database table of quotes.

            //define each quote that gets inserted into the quotes key/value pair data structure. i.e. define rows that get inserted into table
            new List<Quote>
            {
        ...
        public Quote CreateQuote(Quote quote)
        {
            if (quote.Id == 0)
            {
                ...
                quote.Id = key;    //now we have the last key value, assign the Id to the quote
            }
            quotes[quote.Id] = quote;  //insert the quote into quotes key/value data structure.
            return quote;
        }
